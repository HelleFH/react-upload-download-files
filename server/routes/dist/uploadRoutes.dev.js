...
router.post('/upload', function _callee(req, res) {
  var _req$body, title, description, location, file, result, listing;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _req$body = req.body, title = _req$body.title, description = _req$body.description, location = _req$body.location, file = _req$body.file; // Use cloudinary.uploader.upload_stream to handle the file upload directly
